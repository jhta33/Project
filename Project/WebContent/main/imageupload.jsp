...
<body>
	<div id="cont">
		<form method="post" action="insertimg.bv" id="upform1" name="upform1"
			enctype="multipart/form-data">
			<input type="hidden" name="board_num" value="<%=board_num%>" /> <input
				type="hidden" name="mark_num" value="<%=mark_num%>" /> <input
				type="button" value="Send" onclick="sendForm()">
		</form>
	</div>
